...
const Video = () => {
  return (
    <section className=' justify-between gap-6 w-full mt-6  flex-col flex md:flex-1 lg:flex-row '>
      <div>
        ...
        <div className='flex-[5] mx-6 order-2 lg:order-1'>
          <Comments />
        </div>
      </div>
      {/* Recommended Videos Section */}

      <div className='md:flex-[2] flex-[1] order-1 lg:order-2'>
        <Card isSideBar={true} />
        <Card isSideBar={true} />
        <Card isSideBar={true} />
        <Card isSideBar={true} />
